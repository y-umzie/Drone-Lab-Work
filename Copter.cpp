 ...
 *  Umang G             :Nerd who's just learning stuff in this vast vast world (╯°□°）╯︵ ┻━┻
 * ..and many more.
 *
...
void Copter::one_hz_loop()
{
    //My_var_cop	|= (1 << 11);
    //if(var_cnt%10==0){
      //  printf("\nMy_var_cop=%d and My_var_cop2=%d cnt=%ld\n",My_var_cop,My_var_cop2,var_cnt);
    //}
    //var_cnt++;
#if HAL_LOGGING_ENABLED
    if (should_log(MASK_LOG_ANY)) {
